    ...
    <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4 sm:p-8 font-sans">
      {title && (
        <div className="w-full max-w-5xl mb-4 flex items-center justify-between">
          <h1 className="font-display text-sm font-medium text-neutral-400 tracking-widest uppercase">
            {title}
          </h1>
      ...
      {/* Slide Area */}
      <div className="w-full max-w-5xl aspect-video relative overflow-hidden rounded-xl shadow-lg ring-1 ring-white/5">
        {slides.map((slide, i) => (
          <div
            key={i}
            ...
            style={{
              ...
              transform: i === current ? 'scale(1)' : i < current ? 'scale(0.95)' : 'scale(1.02)',
